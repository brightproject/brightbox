## О проекте
*Создание веб инструментария для [команды](http://brightproject.ru) в т.ч. систему личных кабинетов с возможностью обмена сообщениями и файлами, а также браузерные приложения для каждого специалиста, в зависимости от специализации.*
